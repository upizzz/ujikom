      ...
      <div class="col-md-12">
        <form method="post">
          ...
          if (isset($_POST['submit'])) {
            ...
            $penerbit = $_POST['penerbit'];  // Ubah 'ulasan' menjadi 'penerbit'
            ...
            $stmt->bind_param("ssssss", $id_kategori, $judul, $penulis, $penerbit, $tahun_terbit, $deskripsi);
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-8"><input type="text" class="form-control" name="tahun_terbit"></div> <!-- Ubah menjadi type="text" -->
          </div>
          <div class="row mb-3">
